...
class GraphCtrl extends MetricsPanelCtrl {
    ...
    constructor($scope, $injector, private annotationsSrv) {
        ...
        this.events.on('change-nodata-message', this.onNodataMessageChange.bind(this));
    }
    ...
    onNodataMessageChange() {
        this.dataWarning.title = this.panel.nodata;
    }
    ...
    onDataReceived(dataList) {
        ...
        if (datapointsCount === 0) {
            this.dataWarning = {
                title: this.panel.nodata || 'No data points',
